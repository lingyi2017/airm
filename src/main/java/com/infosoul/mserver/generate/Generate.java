package com.infosoul.mserver.generate;
...
import com.infosoul.mserver.common.utils.FileUtils;
import com.infosoul.mserver.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.infosoul.mserver";
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/infosoul/mserver/generate/template", "/", separator);
