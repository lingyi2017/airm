...
public class CRC16M {
	...
	public static void main(String[] args) {
		...
		byte [] b=new byte[]{0x01,0x03,0x02,0x00,0x01,0x00};
		byte[] sbuf2 = CRC16M.getSendBuf(b);

		byte[] sbuf = CRC16M.getSendBuf("010302000100");// 01 03 02 00 01 00 45 E2
		System.out.println(CRC16M.getBufHexStr(sbuf));// 01 03 02 00 01 00 45 E2

	}

	/**
	 * Created by LinW on 2016/12/8.
	 * 返回添加校验后的byte[]  小端
	 * @param toSend
	 * @return
     */
	public static byte[] getSendBuf(byte[] toSend){
		...
		System.arraycopy(toSend,0,bb,0,len);
